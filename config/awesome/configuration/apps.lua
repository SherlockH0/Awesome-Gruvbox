...
return {
	...
	default = {
		...
		music_player = "alacritty -e zsh -c --class music ncmpcpp",
		--- Default text editor
		text_editor = "alacritty -e zsh -c nvim",
		--- Default code editor
		code_editor = "alacritty -e zsh -c nvim",
		--- Default web browser
		web_browser = "firefox",
		--- Default file manager
		file_manager = "nautilus",
		--- Default network manager
		network_manager = "alacritty -e zsh -c nmtui",
